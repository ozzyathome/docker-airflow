...
with DAG(dag_id='testing_dag', schedule_interval="@once", start_date=datetime(2020, 1, 1), catchup=False) as dag:
...
#        )
    ...
    tokenize_csv= DockerOperator(
        ...
        api_version='auto',
        auto_remove=True,
        volumes=['/home/data:/data','/home/scripts:/scripts','/usr/local/output/:/output'], 
        docker_url="unix://var/run/docker.sock",
        network_mode="bridge",
        image='hadesv26',
        command= "python3 -O sand.py /home/data/test.parq /data/testresult.parq email.yaml -pack 10000 -logfile /scripts/testynrg2.log"
